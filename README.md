...
- **Sección de la temporada de la portada** y el aviso de la cabecera: `src/app/pages/home/home.html` (busca `season-section` y `hero__badge`). La clase y la raza nuevas que destaca y la fecha de salida de la temporada (`SEASON_LAUNCH`, que cambia el aviso de «llega el…» a «Ya disponible») están en `home.ts`.
